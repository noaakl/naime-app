...
const RankInfo = ({ searchedName, name, algorithem }) => {
    ...
    // const likedThisName = username && algorithem in algorithems && likes[searchedName].includes(name.candidate)
    // const dislikedThisName = username && algorithem in algorithems && dislikes[searchedName].includes(name.candidate)
